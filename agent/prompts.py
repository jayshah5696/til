...
def generate_prompt_template(query, context_list):
    ...
    in <instruction><output_format><citation_style>and<additional_guidelines>.
    ...
    4. Include inline citations for each piece of information used, referencing the source URLs.
    ...
    2. The main body of the answer, addressing all aspects of the query.
    3. A concise conclusion that recaps the key points.
    4. (Optional) Suggestions for further reading or related topics, if relevant.
    </output_format>
    ...
    - Aim for a response length that is comprehensive yet concise, typically 2-4 paragraphs.
